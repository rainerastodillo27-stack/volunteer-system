...
<head>
  <meta charset="UTF-8">
  <title>Negros Volunteer for Change Analytics Report</title>
  <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Nunito:wght@300;400;500;600;700;800&display=swap">
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body { font-family: 'Nunito', sans-serif; padding: 40px; background: #f8f9fa; color: #333; }
...
<body>
  <div class="container">
    <div class="header">
      <h1>📊 Negros Volunteer for Change Analytics Report</h1>
...
`;
  ...
  html += `
    <div class="footer">
      <p>Generated by Negros Volunteer for Change Analytics System</p>
