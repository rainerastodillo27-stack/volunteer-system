...
const styles = StyleSheet.create({
  ...
  webHeroHeadingOriginal: {
    ...
    marginBottom: 16,
    maxWidth: 620,
    ...({ textShadow: "0px 4px 12px rgba(0, 0, 0, 0.45)" } as any),
  ...
  webHeroSubHeadingOriginal: {
    ...
    lineHeight: 32,
    maxWidth: 580,
    ...({ textShadow: "0px 2px 8px rgba(0, 0, 0, 0.35)" } as any),
    fontFamily: "'Nunito', sans-serif",
    letterSpacing: 0.2,
  },
  webHeroHeading: {
    ...
    lineHeight: 56,
    marginBottom: 20,
    ...({ textShadow: "0px 4px 10px rgba(0, 0, 0, 0.3)" } as any),
  },
  webHeroText: {
    color: "#f0fdf4",
    fontSize: 16,
    ...
    marginBottom: 20,
    maxWidth: 620,
    ...({ textShadow: "0px 2px 6px rgba(0, 0, 0, 0.2)" } as any),
  },
  webHeroNote: {
  ...
  leftBrandTitle: {
    ...
    color: "#ffffff",
    letterSpacing: 0.5,
    ...({ textShadow: "0px 2px 6px rgba(0, 0, 0, 0.3)" } as any),
  },
  pillBadge: {
