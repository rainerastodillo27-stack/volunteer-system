        ...
        try:
            ...
            if role == "volunteer":
                ...
                partner = {
                    ...
                    "region": str(partner_registration.get("region") or "").strip(),
                    "province": str(partner_registration.get("province") or "").strip(),
                    "cityMunicipality": str(partner_registration.get("cityMunicipality") or "").strip(),
